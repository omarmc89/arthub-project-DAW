...
const config = { theme, corePlugins, plugins, content, darkMode, mode, safelist, variants, presets, prefix, important, separator, blocklist }
export { config as default, theme, corePlugins, plugins, content, darkMode, mode, safelist, variants, presets, prefix, important, separator, blocklist }