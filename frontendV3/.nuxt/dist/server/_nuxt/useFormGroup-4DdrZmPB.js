...
const useFormGroup = (inputProps, config) => {
  ...
  return {
    ...
    size: computed(() => {
      ...
      return (inputProps == null ? void 0 : inputProps.size) ?? formGroupSize ?? ((_a = config == null ? void 0 : config.default) == null ? void 0 : _a.size);
    }),
    color: computed(() => {
      var _a;
...
//# sourceMappingURL=useFormGroup-4DdrZmPB.js.map
