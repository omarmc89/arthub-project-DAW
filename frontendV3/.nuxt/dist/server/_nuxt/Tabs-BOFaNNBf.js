...
import { defineComponent, ref, h, computed, provide, onMounted, watch, watchEffect, Fragment, onUnmounted, inject, toRef, resolveComponent, mergeProps, withCtx, createVNode, renderSlot, toDisplayString, openBlock, createBlock, renderList, createTextVNode, useSSRContext } from "vue";
import { o, A, T, I, N, u, a as o$1, l } from "./keyboard-StezvEZ1.js";
import { s as s$1 } from "./use-resolve-button-type-BiIC-zUM.js";
import { f, s } from "./hidden-BCOMh9xa.js";
import { O, T as T$1, i, P, N as N$1 } from "./focus-management-BvtO1QQs.js";
...
let G = Symbol("TabsSSRContext"), pe = defineComponent({ name: "TabGroup", emits: { change: (a) => true }, props: { as: { type: [Object, String], default: "template" }, selectedIndex: { type: [Number], default: null }, defaultIndex: { type: [Number], default: 0 }, vertical: { type: [Boolean], default: false }, manual: { type: [Boolean], default: false } }, inheritAttrs: false, setup(a, { slots: b, attrs: s2, emit: o$12 }) {
  ...
  let u$1 = { selectedIndex: computed(() => {
    ...
    l2.value.push(t2), l2.value = O(l2.value, o);
  ...
  function T2(e) {
    ...
    if (c === T$1.Success && l2.activation.value === "auto") {
      let p = (I2 = i(r)) == null ? void 0 : I2.activeElement, D = l2.tabs.value.findIndex((O2) => o(O2) === p);
      D !== -1 && l2.setSelectedIndex(D);
    }
    return c;
  }
  function m(e) {
    let c = l2.tabs.value.map((p) => o(p)).filter(Boolean);
  ...
  function w() {
    var e;
    R.value || (R.value = true, !a.disabled && ((e = o(r)) == null || e.focus({ preventScroll: true }), l2.setSelectedIndex(y.value), t(() => {
      R.value = false;
    })));
  }
  function t$1(e) {
  ...
  return () => {
    var p;
    let e = { selected: u$1.value }, { ...c } = a, I2 = { ref: r, onKeydown: m, onMousedown: t$1, onClick: w, id: i$1, role: "tab", type: n.value, "aria-controls": (p = o(l2.panels.value[y.value])) == null ? void 0 : p.id, "aria-selected": u$1.value, tabIndex: u$1.value ? 0 : -1, disabled: a.disabled ? true : void 0 };
  ...
  return () => {
    var n;
    let m = { selected: u2.value }, { tabIndex: R, ...w } = a, t2 = { ref: r, id: i2, role: "tabpanel", "aria-labelledby": (n = o(l2.tabs.value[y.value])) == null ? void 0 : n.id, tabIndex: u2.value ? R : -1 };
...
//# sourceMappingURL=Tabs-BOFaNNBf.js.map
