...
import { i as i$1, u as u$1, f, c } from './calculate-active-index-D7B59bcw.mjs';
import { t, i, l } from './open-closed-BDzQJ33n.mjs';
import { w as w$1, h, v, N as N$1, _, O as O$1 } from './focus-management-BvtO1QQs.mjs';
...
import { d as dropdown, u as useUI } from './tooltip-BFZnfYSQ.mjs';
import { u as usePopper } from './usePopper-CcmLcrd_.mjs';
import { m as mergeConfig, g as appConfig, _ as _export_sfc } from './server.mjs';
import { ssrRenderComponent, ssrRenderSlot, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderStyle, ssrRenderList, ssrRenderVNode, ssrInterpolate } from 'file:///Users/omarmartin/Documents/DAW/arthub-project-DAW/frontendV3/node_modules/vue/server-renderer/index.mjs';
import { g as getNuxtLinkProps } from './link-WrO2rrG0.mjs';
...
let ge = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(i$12, { slots: b, attrs: o$12 }) {
  ...
  return () => {
    var n;
    let l2 = { open: e.menuState.value === 0 }, { ...t2 } = i2, a = { ref: e.buttonRef, id: p2, type: g.value, "aria-haspopup": "menu", "aria-controls": (n = o$1(e.itemsRef)) == null ? void 0 : n.id, "aria-expanded": e.menuState.value === 0, onKeydown: r, onKeyup: f2, onClick: d };
  ...
  return () => {
    var s2, v2;
    let t2 = { open: e.menuState.value === 0 }, { ...a } = i$2, n = { "aria-activedescendant": e.activeItemIndex.value === null || (s2 = e.items.value[e.activeItemIndex.value]) == null ? void 0 : s2.id, "aria-labelledby": (v2 = o$1(e.buttonRef)) == null ? void 0 : v2.id, id: p2, onKeydown: f2, onKeyup: d, role: "menu", tabIndex: 0, ref: e.itemsRef };
...
//# sourceMappingURL=Dropdown-D8fYjvZk.mjs.map
