import { defineComponent, ref, computed, onMounted, onUnmounted, h, Fragment, watchEffect, watch, inject, provide, nextTick, normalizeClass, shallowRef } from 'file:///Users/omarmartin/Documents/DAW/arthub-project-DAW/frontendV3/node_modules/vue/index.mjs';
import { n, E as E$1, A as A$3, N as N$1$1, u as u$2, _, a as N$2, d as d$2 } from './portal-B5DpPacA.mjs';
import { f, s as s$1 } from './hidden-BCOMh9xa.mjs';
import { t as t$3, o as o$2 } from './disposables-lSGnSUs6.mjs';
import { A as A$2, o as o$1, I, u as u$1, a as o, N as N$3, S as S$1, T as T$1 } from './keyboard-StezvEZ1.mjs';
import { i as i$1, S, c as c$1, P, N as N$4, T as T$2 } from './focus-management-BvtO1QQs.mjs';
import { t as t$1 } from './micro-task-B6uncIso.mjs';
import { w as w$1, t as t$4 } from './use-outside-click-DPs8-blD.mjs';
import { l as l$2, i as i$2, s as s$2, t as t$2 } from './open-closed-BDzQJ33n.mjs';
import { k } from './description-CT80-Yva.mjs';
...
let ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n$1, slots: r, expose: l2 }) {
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$1(T2, d2) || (s2.value ? P(o$1(o$12), u$1(f$1.value, { [d$2.Forwards]: () => N$4.Next, [d$2.Backwards]: () => N$4.Previous }) | N$4.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S(u2.target)));
  }
  return () => {
  ...
  return onMounted(() => i2.value = true), onUnmounted(() => i2.value = false), onMounted(() => {
    watch([n2, r, l2], (e, m2) => {
      ...
      f2 && t$1(() => {
        ...
        a2 ? S(a2) : P(f2, N$4.First | N$4.NoScroll) === T$2.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), o$12.value = (H2 = t2.value) == null ? void 0 : H2.activeElement;
      });
...
let A = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", We = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (e) => true }, setup(e, { emit: i2, attrs: l2, slots: d2, expose: s$12 }) {
  ...
  E$1((q = E$2.value) == null ? void 0 : q.defaultView, "keydown", (t2) => {
    ie.value && (t2.defaultPrevented || t2.key === o.Escape && (t2.preventDefault(), t2.stopPropagation(), h$1.close()));
  });
  ...
  return d$1(E$2, ue$1, (t2) => {
    ...
    return h(u$2, { force: true }, () => [h(_, () => h(N$2, { target: m2.value }, () => h(u$2, { force: false }, () => h(ue, { initialFocus: a2, containers: B2, features: k$1.value ? u$1(ee.value, { parent: ue.features.RestoreFocus, leaf: ue.features.All & ~ue.features.FocusLock }) : ue.features.None }, () => h(X, {}, () => A$2({ ourProps: f2, theirProps: { ...p, ...l2 }, slot: L2, attrs: l2, slots: d2, visible: c2.value === 0, features: N$3.RenderStrategy | N$3.Static, name: "Dialog" })))))), h(Z)]);
  };
} });
...
let W = N$3.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t2, attrs: a2, slots: s2, expose: h$1 }) {
  ...
  function te(o$12) {
    let E2 = I$1.value && !A2.value, p = o$1(d2);
  ...
  }), provide(N, P2), t$2(computed(() => u$1(i2.value, { ["visible"]: i$2.Open, ["hidden"]: i$2.Closed }) | n2.value)), () => {
...
export { Ge as G, Se as S, We as W, he as h };
//# sourceMappingURL=transition-Cue-PHOH.mjs.map
