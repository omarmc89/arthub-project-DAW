...
import { defineComponent, computed, ref, watch, provide, h, cloneVNode, reactive, onMounted, Fragment, watchEffect, inject, onUnmounted, nextTick, toRaw } from "vue";
import { d, e } from "./form-Bxt8P_zR.js";
import { o, u, E, A, T, I, N as N$1, a as o$1 } from "./keyboard-StezvEZ1.js";
import { w, n } from "./use-outside-click-DPs8-blD.js";
import { s as s$1 } from "./use-resolve-button-type-BiIC-zUM.js";
import { c, f, i as i$2, u as u$1 } from "./calculate-active-index-D7B59bcw.js";
import { f as f$1, s } from "./hidden-BCOMh9xa.js";
import { t, i, l } from "./open-closed-BDzQJ33n.js";
import { o as o$2, t as t$1 } from "./disposables-lSGnSUs6.js";
import { i as i$1, O } from "./focus-management-BvtO1QQs.js";
function Pe(a, T2) {
  return a === T2;
}
...
let ie = Symbol("VirtualContext"), ke = defineComponent({ name: "VirtualProvider", setup(a, { slots: T2 }) {
  ...
  function D(l2 = (i2) => i2) {
    let i2 = d$1.value !== null ? b.value[d$1.value] : null, f2 = l2(b.value.slice()), p = f2.length > 0 && f2[0].dataRef.order.value !== null ? f2.sort((C, F) => C.dataRef.order.value - F.dataRef.order.value) : O(f2, (C) => o(C.dataRef.domRef)), O$1 = i2 ? p.indexOf(i2) : null;
  ...
  let t$12 = { comboboxState: o$12, value: k, mode: L, compare(l2, i2) {
    ...
    d$1.value === null && t$12.isSelected(i2.value.value) && (p.activeOptionIndex = p.options.indexOf(f2)), b.value = p.options, d$1.value = p.activeOptionIndex, V.value = 2, p.options.some((O2) => !o(O2.dataRef.domRef)) && (y = requestAnimationFrame(() => {
      let O2 = D();
  ...
  let I2 = computed(() => {
    var l2;
    return (l2 = o(e$1)) == null ? void 0 : l2.closest("form");
  });
  return onMounted(() => {
    watch([I2], () => {
...
defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(a, { attrs: T2, slots: r }) {
  ...
  function u2() {
    var v;
    (v = o(o$12.inputRef)) == null || v.focus({ preventScroll: true });
  }
  return () => {
...
let tt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: T2, slots: r, expose: R }) {
  ...
  function e2(b) {
    u2.disabled.value || (u2.comboboxState.value === 0 ? u2.closeCombobox() : (b.preventDefault(), u2.openCombobox()), nextTick(() => {
      var d2;
      return (d2 = o(u2.inputRef)) == null ? void 0 : d2.focus({ preventScroll: true });
    }));
  }
  function v(b) {
    switch (b.key) {
  ...
  return () => {
    var P, D;
    let b = { open: u2.comboboxState.value === 0, disabled: u2.disabled.value, value: u2.value.value }, { ...d2 } = a, V = { ref: u2.buttonRef, id: o$22, type: s2.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (P = o(u2.optionsRef)) == null ? void 0 : P.id, "aria-expanded": u2.comboboxState.value === 0, "aria-labelledby": u2.labelRef.value ? [(D = o(u2.labelRef)) == null ? void 0 : D.id, o$22].join(" ") : void 0, disabled: u2.disabled.value === true ? true : void 0, onKeydown: v, onClick: e2 };
  ...
  var k;
  let u$12 = (k = a.id) != null ? k : `headlessui-combobox-input-${I()}`, e2 = N("ComboboxInput"), v = computed(() => i$1(o(e2.inputRef))), s2 = { value: false };
  o$3({ el: e2.inputRef, $el: e2.inputRef });
  function h2() {
    e2.change(null);
    let n2 = o(e2.optionsRef);
    n2 && (n2.scrollTop = 0), e2.goToOption(c.Nothing);
  }
  let b = computed(() => {
    var y;
    let n2 = e2.value.value;
    return o(e2.inputRef) ? typeof a.displayValue != "undefined" && n2 !== void 0 ? (y = a.displayValue(n2)) != null ? y : "" : typeof n2 == "string" ? n2 : "" : "";
  });
  onMounted(() => {
    watch([b, e2.comboboxState, v], ([n2, y], [S, w2]) => {
      if (s2.value)
        return;
      let t2 = o(e2.inputRef);
  ...
  function K(n2) {
    ...
    if (s2.value = false, !((w2 = o(e2.optionsRef)) != null && w2.contains(y)) && !((t2 = o(e2.buttonRef)) != null && t2.contains(y)) && e2.comboboxState.value === 0)
  ...
  function c$1(n2) {
    var S, w2, t2;
    let y = (S = n2.relatedTarget) != null ? S : t$1.find((I2) => I2 !== n2.currentTarget);
    (w2 = o(e2.buttonRef)) != null && w2.contains(y) || (t2 = o(e2.optionsRef)) != null && t2.contains(y) || e2.disabled.value || e2.immediate.value && e2.comboboxState.value !== 0 && (e2.openCombobox(), o$2().nextFrame(() => {
  ...
  return i$2({ container: computed(() => o(o$12.optionsRef)), enabled: computed(() => o$12.comboboxState.value === 0), accept(s2) {
    ...
    var d2, V, P;
    let s2 = { open: o$12.comboboxState.value === 0 }, h$1 = { "aria-labelledby": (P = (d2 = o(o$12.labelRef)) == null ? void 0 : d2.id) != null ? P : (V = o(o$12.buttonRef)) == null ? void 0 : V.id, id: u2, ref: o$12.optionsRef, role: "listbox", "aria-multiselectable": o$12.mode.value === 1 ? true : void 0 }, b = T(a, ["hold"]);
  ...
  onMounted(() => o$12.registerOption(u2, b)), onUnmounted(() => o$12.unregisterOption(u2, v.value)), watchEffect(() => {
    ...
    o$12.comboboxState.value === 0 && v.value && (o$12.virtual.value || o$12.activationTrigger.value !== 0 && nextTick(() => {
      var c2, g;
      return (g = (c2 = o(e2)) == null ? void 0 : c2.scrollIntoView) == null ? void 0 : g.call(c2, { block: "nearest" });
    }));
  });
  function d2(c2) {
    var g;
    ...
    o$12.selectOption(u2), n() || requestAnimationFrame(() => {
      var k;
      return (k = o(o$12.inputRef)) == null ? void 0 : k.focus({ preventScroll: true });
...
//# sourceMappingURL=combobox-DngOzaUq.js.map
