import { inject, ref, computed } from 'file:///Users/omarmartin/Documents/DAW/arthub-project-DAW/frontendV3/node_modules/vue/index.mjs';
...
const useFormGroup = (inputProps, config) => {
  ...
  return {
    ...
    size: computed(() => {
      ...
      return (_b = (_a2 = inputProps == null ? void 0 : inputProps.size) != null ? _a2 : formGroupSize) != null ? _b : (_a = config == null ? void 0 : config.default) == null ? void 0 : _a.size;
    }),
    color: computed(() => {
      var _a;
...
//# sourceMappingURL=useFormGroup-4DdrZmPB.mjs.map
