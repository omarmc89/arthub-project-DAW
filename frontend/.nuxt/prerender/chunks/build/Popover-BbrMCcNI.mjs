...
import { defineComponent, ref, computed, provide, watchEffect, h as h$1, Fragment, onMounted, onUnmounted, shallowRef, toRef, watch, useSSRContext, inject, resolveComponent, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, Transition, createCommentVNode } from 'file:///Users/omarmartin/Documents/DAW/arthub-project-DAW/frontendV3/node_modules/vue/index.mjs';
import { defu } from 'file:///Users/omarmartin/Documents/DAW/arthub-project-DAW/frontendV3/node_modules/defu/dist/defu.mjs';
import { A, N as N$1, E as E$1, n, v, d } from './portal-B5DpPacA.mjs';
import { o as o$1, u, A as A$1, I, N, l as l$1, a as o } from './keyboard-StezvEZ1.mjs';
import { w } from './use-outside-click-DPs8-blD.mjs';
import { s } from './use-resolve-button-type-BiIC-zUM.mjs';
import { f, s as s$1 } from './hidden-BCOMh9xa.mjs';
import { t, i as i$1, l } from './open-closed-BDzQJ33n.mjs';
import { i, E, w as w$1, h, P, N as N$2, T } from './focus-management-BvtO1QQs.mjs';
...
import { ssrRenderComponent, ssrRenderSlot, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderStyle } from 'file:///Users/omarmartin/Documents/DAW/arthub-project-DAW/frontendV3/node_modules/vue/server-renderer/index.mjs';
...
let ye = defineComponent({ name: "Popover", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d2, { slots: P2, attrs: s2, expose: h$2 }) {
  ...
  let S = { buttonId: a.buttonId, panelId: a.panelId, close() {
    a.closePopover();
  } }, c = ae(), I2 = c == null ? void 0 : c.registerPopover, [F, w$2] = A(), i$2 = N$1({ mainTreeNodeRef: c == null ? void 0 : c.mainTreeNodeRef, portals: F, defaultContainers: [o$12, m] });
  function p() {
    var e, r, l2, g;
  ...
  return watchEffect(() => I2 == null ? void 0 : I2(S)), E$1((u$1 = b.value) == null ? void 0 : u$1.defaultView, "focus", (e) => {
    var r, l2;
    e.target !== void 0 && e.target instanceof HTMLElement && t$1.value === 0 && (p() || o$12 && m && (i$2.contains(e.target) || (r = o$1(a.beforePanelSentinel)) != null && r.contains(e.target) || (l2 = o$1(a.afterPanelSentinel)) != null && l2.contains(e.target) || a.closePopover()));
  }, true), w(i$2.resolveContainers, (e, r) => {
    var l2;
    a.closePopover(), w$1(r, h.Loose) || (e.preventDefault(), (l2 = o$1(o$12)) == null || l2.focus());
  ...
  function p() {
    ...
    if (!e)
      return;
    function r() {
      u(i$12.value, { [d.Forwards]: () => P(e, N$2.First), [d.Backwards]: () => P(e, N$2.Last) }) === T.Error && P(E().filter((g) => g.dataset.headlessuiFocusGuard !== "true"), u(i$12.value, { [d.Forwards]: N$2.Next, [d.Backwards]: N$2.Previous }), { relativeTo: o$1(t2.button) });
    }
    r();
  }
  return () => {
    let e = t2.popoverState.value === 0, r = { open: e }, { ...l2 } = d$1, g = b.value ? { ref: E$12, type: S.value, onKeydown: c, onClick: F } : { ref: E$12, id: f$1, type: S.value, "aria-expanded": t2.popoverState.value === 0, "aria-controls": o$1(t2.panel) ? t2.panelId.value : void 0, disabled: d$1.disabled ? true : void 0, onKeydown: c, onKeyup: I$1, onClick: F, onMousedown: w2 };
...
let je = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: null } }, inheritAttrs: false, setup(d$1, { attrs: P$1, slots: s2, expose: h2 }) {
  ...
  h2({ el: o$2.panel, $el: o$2.panel }), onMounted(() => {
    ...
    (u2 = o$1(o$2.panel)) != null && u2.contains(i2) || P(o$1(o$2.panel), N$2.First);
  });
  ...
  function I$1() {
    ...
    function p() {
      u(c.value, { [d.Forwards]: () => {
        var e;
        P(i2, N$2.First) === T.Error && ((e = o$1(o$2.afterPanelSentinel)) == null || e.focus());
      }, [d.Backwards]: () => {
        var u2;
  ...
  function F() {
    ...
    function p() {
      u(c.value, { [d.Forwards]: () => {
        ...
        var e;
        P(i2, N$2.Previous) === T.Error && ((e = o$1(o$2.button)) == null || e.focus());
      } });
    }
    p();
  }
...
//# sourceMappingURL=Popover-BbrMCcNI.mjs.map
