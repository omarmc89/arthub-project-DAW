import { watchEffect, ref, h, defineComponent, provide, computed, inject, onMounted, getCurrentInstance, watch, onUnmounted, Teleport, reactive } from 'file:///Users/omarmartin/Documents/DAW/arthub-project-DAW/frontendV3/node_modules/vue/index.mjs';
import { c as c$1, i } from './focus-management-BvtO1QQs.mjs';
import { a as w$1 } from './use-outside-click-DPs8-blD.mjs';
import { f, s as s$1 } from './hidden-BCOMh9xa.mjs';
import { A as A$1, o as o$1 } from './keyboard-StezvEZ1.mjs';
...
let _ = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(r, { slots: e2, attrs: u2 }) {
  let t = ref(null), i$1 = computed(() => i(t)), l = s(), n2 = inject(C, null), o$1$1 = ref(l === true || n2 == null ? x(t.value) : n2.resolveTarget()), d2 = ref(false);
  onMounted(() => {
    d2.value = true;
  }), watchEffect(() => {
...
export { A, E, N$1 as N, _, N as a, d, n, u, v };
//# sourceMappingURL=portal-B5DpPacA.mjs.map
